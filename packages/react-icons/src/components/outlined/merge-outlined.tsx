...
export function MergeOutlined(props: IconProps): React.JSX.Element {
  ...
  return (
    <svg
      ...
      {...rest}
    >
      <g clipPath={`url(#${UNIQUE_ID_NUMBER_1})`} transform="matrix(1 0 0 -1 172 924)">
        <path d="M76 172H148V660H76z" fill={color}></path>
