<script setup lang="ts">
  ...
  const topToBottomExtraStyles = computed<CSSProperties>(() => ({
    ...
    top: `${-props.link.cornerSize - props.link.topToBottomExtra}px`,
  }));
  const cornerExtraFirstStyles = computed<CSSProperties>(() => ({
    left: `${props.link.leftToRightFirst}px`,
    top: `${-(props.link.cornerSize * 2) - props.link.topToBottomExtra}px`,
  }));
  ...
  const cornerExtraSecondStyles = computed<CSSProperties>(() => ({
    ...
    top: `${-(props.link.cornerSize * 3) - props.link.topToBottomExtra}px`,
  }));
  const topToBottomStyles = computed<CSSProperties>(() => ({
    ...
    top: props.link.extraCorner
      ? `${-(props.link.cornerSize * 3) - props.link.topToBottomExtra - props.link.topToBottom}px`
      : `${-props.link.cornerSize - props.link.topToBottom}px`,
  }));
  const cornerSecondStyles = computed<CSSProperties>(() => ({
    left: props.link.extraCorner
      ...
      : `${props.link.leftToRightFirst + props.link.cornerSize}px`,
    top: props.link.extraCorner
      ? `${-(props.link.cornerSize * 4) - props.link.topToBottomExtra - props.link.topToBottom}px`
      : `${-(props.link.cornerSize * 2) - props.link.topToBottom}px`,
  }));
  ...
  const arrowStyles = computed<CSSProperties>(() => ({
    ...
    top: props.link.extraCorner
      ? `${-(props.link.cornerSize * 4) - props.link.topToBottomExtra - props.link.topToBottom - props.link.arrowSize / 2 + props.link.topArrowShift}px`
      : `${-(props.link.cornerSize * 2) - props.link.topToBottom - props.link.arrowSize / 2 + props.link.topArrowShift}px`,
  }));
</script>
